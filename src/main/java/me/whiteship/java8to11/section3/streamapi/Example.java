package me.whiteship.java8to11.section3.streamapi;
...
public class Example {
	...
	public static void main(String[] args) {
		...
		// 모든 수업
		List<List<OnlineClass>> juwonEvents = new ArrayList<>();
		juwonEvents.add(springClasses);
		juwonEvents.add(javaClasses);
		...
		System.out.println("close 되지 않은 수업2");
		springClasses.stream()
		...
		System.out.println("두 수업 목록에 들어있는 모든 수업 아이디 출력2");
		juwonEvents.stream()
